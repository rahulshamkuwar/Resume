...
{Bachelor of Science in Computer Science;  GPA: 3.91}{Fall 2022 -- Fall 2024}\vspace{-2pt}
\resumeSubheading
...
\resumeSubItem{Tools}
{AWS, OCI, Docker, GitHub Actions, Git, ESLint, Prisma, Firebase, pandas, NumPy, JupyterLab, Jira, Jest.}
...
{Conceptualized and crafted an open source, dynamic mobile application that harnessed the power of AniList's GraphQL API, establishing a cutting-edge platform for users to access and interact with anime-related content.}\vspace{-10pt}
\resumeSubItem{Achieved 2nd Place at HackCU}
{Engineered a Chess-Street Fighter-inspired Unity game in just 24 hours, showcasing adaptability and creativity.}\vspace{-5pt}
\resumeSubHeadingListEnd
